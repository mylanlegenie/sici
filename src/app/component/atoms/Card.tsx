...
export default function Card({
  ...
  return (
    <article className="cursor-pointer group mt-6 flex min-h-84 w-full flex-col items-center justify-between rounded-2xl border border-zinc-200 bg-white px-5 py-6 text-center shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl">
      <Link
        ...
        <div className="w-full ">
          ...
          >
            <Image
              ...
              width={180}
              height={180}
              className="mx-auto  cursor-pointer rounded-full border border-zinc-200 object-cover p-1 transition duration-300 group-hover:scale-105"
            />
          </button>

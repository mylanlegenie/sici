  ...
  return (
    <section className="relative z-10 mx-auto mb-12 mt-20 w-[80vw] max-w-5xl px-2 text-center text-gray-900 sm:mb-16 dark:text-gray-100">
      ...
      <p className="text-white text-sm sm:text-base md:text-lg mb-6">
        Venez découvrir{" "}
        <span className="font-semibold  text-red-300">La Sicilienne</span> dans
        le 12ème arrondissement de Paris. Notre restaurant vous accueille avec
        des plats italiens et tex-mex préparés avec passion.
      </p>

  ...
  return (
    <section className="w-[90%] max-w-5xl mx-auto my-12 sm:my-16 relative z-10 text-center px-2 text-gray-900 dark:text-gray-100">
      ...
      <div>
        <div
          ref={containerRef}
          className="relative overflow-hidden rounded-xl shadow-lg mx-auto w-full max-w-[974px]"
          style={{
            aspectRatio: "974 / 362",
            height: "auto",
            minHeight: "220px",
            ...(typeof window !== "undefined" && window.innerWidth < 640
              ? { aspectRatio: "1/1.1", minHeight: "320px" }
              : {}),
          }}
        >
          <iframe
            ...
            className="absolute inset-0 h-full w-full rounded-x border-4 border-amber-500 z-0"
            loading="lazy"
